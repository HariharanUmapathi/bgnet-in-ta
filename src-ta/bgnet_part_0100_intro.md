...
முதலில் விண்டோஸ் கணிணியில் நீங்கள் செய்யவேண்டியது.
...
ஒரு முறை நீங்கள் வின்சாக் நூலகத்தினை இணைத்த பெரும்பாலன நிரல்களுக்கு பொருந்துமாறு அது இருக்கும்.
இருப்பினும் சில விலக்குகளும் இருக்கின்றன.
அவை நீங்கள் சாக்கெட்டினை பயன்படுத்திய பின் மூட `close()`-ஐ பயன்படுத்த இயலாது. அதற்கு பதிலாக
[i[`closesocket()` function]] `closesocket()` ஐ பயன்படுத்திகொள்ளவும்.
அதேபோல் [i[`select()` function]] `select()` ஆனது சாக்கெட்டிற்கு மட்டும் பயன்படுத்தவும்
கோப்பு வரும் இடங்களில் பயன்படுத்த வேண்டாம். அது சரிவர இயங்காது.
...
தங்களுடைய நிரல்மொழிபெயர்ப்பின் உதவி பகுதியில் சாக்கெட் இனக்குழு பற்றிய பிறவிவரங்கள் யாவும் தெரிந்துகொள்க
[i[`CSocket` class]] [`CSocket`](https://learn.microsoft.com/en-us/cpp/mfc/reference/csocket-class?view=msvc-170)
...
வின்சாக்(Winsock) பற்றி மேலுமறிய, [check out the official page at
...
முடிவாக நான் கேள்விபட்ட வகையில் விண்டோஸ் (Windows) ல் [i[`fork()` function]] `fork()` எனக்கூடிய
அமைப்பு செயல்கூறு (system call) கிடைக்ககாமல் இருப்பதால் நீங்கள் அந்த சமயங்களில் POSIX நூலகங்களையோ (அ)
[i[`CreateProcess()` function]] `CreateProcess()` -யோ பயன்படுத்தலாம்.
`fork()` அளபுருக்கள் இல்லாமல் மற்றும் `CreateProcess()` 48 பில்லியன் அளபுருக்களையும் பெறுகிறது.
உங்களுக்கு அவ்வளவு தேவையில்லையெனில் சற்று எளிமையாக [i[`CreateThread()`
function]] `CreateThread()` ஐ பயன்படுத்திக்கொள்ளுங்கள் புரிந்துகொள்ளவும் எளிமையாக இருக்கும்.
மன்னிக்கவும் multithreading பற்றிய விவாதங்கள் யாவும் இந்த தலைப்பிற்கு அப்பாற்பட்டது!
ஆகையால் எனக்கு தெரிந்த வகையிலே மட்டும் முடிக்கிறேன் இதை தாங்களும் அறிவீர்.
...
மேலதிகமாக, ஸ்டீவன் மிட்சல் (Steven Mitchell) அவர்களின் [fl[ported a number of the
examples|https://www.tallyhawk.net/WinsockExamples/]] (Winsock) வின்சாக்கிற்கான 
உதாரணங்களையும் பாருங்கள்.
...
நான் பெரும்பாலும் மின்மடல் [i[Emailing Beej]] சந்தேககளுக்கு பதிலளிப்பேன் ஆகவே தயக்கமின்றி எழுதுங்கள்.
சில நேரங்களில் தவிற்க முடியாத காரணங்களால் என்னால் பதிலளிக்க இயலாது.
சில பதிலளிக்க இயலாத கேள்விகளுக்கு நான் கேள்வி மடலை நீக்கிவிடுவேன்.
பதில் தெரியாததால் அல்ல நீங்கள் வினவும் அளவிற்கு என்னா அதுசமயம் பதில் எழுத இயலாது.
இது ஒரு குறிப்பிட்ட மடலுக்கான ஒன்று இல்லை.யார் மீதும் எனக்கு பகையில்லை :) 
...
ஒரு விதியை மடல் அனுப்பும்முன் நினைவில் கொள்ளுங்கள். உங்கள் கேள்வி மிகவும் சிக்கலாக
இருக்குமேயானால் அதற்கு நான் பதிலளிப்பது சிரமம்.

மேலும் கேள்விக்கு தரம் கூட்டும் விவரங்கள் (இயங்குதளம், நிரல்மொழிபெயர்ப்பி, பிழைச் செய்திகள்,
மேலும் தங்களின் சிக்கலை நான் தீர்க்க எனக்கு தேவைப்படும் எந்த ஒருவிவரத்தையும் தவறாது குறிப்பிட்டுங்கள்)
நீங்கள் பதில் பெற இது அதிக வாய்ப்பை நல்கும்.

மேலும் கேள்வி கேட்பதில் எற்படும் சந்தேகங்களுக்கு [fl[How To Ask Questions The Smart
Way|http://www.catb.org/~esr/faqs/smart-questions.html]].-ஐ பாருங்கள்.
...
நீங்கள் பதில் பெறாவிடில் மேலும் அராய்ந்து பதில் கான முயலுங்கள்.
எனினும் தீர்வுகிடைக்காத பட்சத்தில் எனக்கு மீண்டும் எழுதுங்கள்.
...
இப்பொழுது எனக்கு மட்டுமல்ல பொதுவாகவே எப்படி எழுதுவது என்று கற்றிருப்பீர்கள்.
இந்த கையேடு காலம் காலமாக பெறும் வரவேற்பினை படிக்கும் வாசகர்களுக்கு தெரியப்படுத்துவதில் மகிழ்ச்சி.
நான் பெறும் வாழ்த்துகள் யாவும் நல்தொரு உத்வேகத்தை அளிக்கிறது. 
...
## Mirroring
## நகல் வலைதளம் (Mirroring)
[i[Mirroring the Guide]] நீங்கள் இந்த வலைதளத்தினை நகலாக்கி வெளியிட பொதுவெளியிலோ (அ)
தனியாகவோ வரவேற்கப்படுகிறீர்கள். நீங்கள் பொதுவெளியில் வெளியிட்டால் எனக்கு மின்மடலில் [`beej@beej.us`](mailto:beej@beej.us).
தெரியப்படுத்துங்கள். நான் முல வளைதளத்தில் நகல் தளத்தின் இணைப்பினை சேர்க்கிறேன்.
...
## மொழிபெயர்ப்பாளர்களுக்கான குறிப்பு
[i[Translating the Guide]] நீங்கள் இந்த கையேட்டினை எந்த மொழியிலும் மொழிபெயர்க்கலாம்.
தங்களின் மொழிபெயர்ப்பினை முதன்மை பக்கத்தில் இணைக்க [`beej@beej.us`](mailto:beej@beej.us)
தொடர்பு கொள்ளவும். தங்களது பெயர் மற்றும் தொடர்பு விவரத்தினை தயக்கமின்றி குறிப்பிடுங்கள்.
...
இந்த முல மார்க்டவுன் ஆவணமானது UTF-8 குறிமுறையை பயன்படுத்துகிறது.
This source markdown document uses UTF-8 encoding.

உரிமத்தின் வரம்புகள் யாவும் கீழே [Copyright, Distribution,
and Legal](#legal) பகுதியில்.
...
தங்களது மொழிபெயர்ப்பினை என்னுடைய வலையில் வெளியிடவேண்டுமெனில் எனக்கு மின்மடல் அனுப்புங்கள்.
தாங்களே வெளியிட்டலும் சரி.  


## Copyright, Distribution, and Legal {#legal}
## பதிப்புரிமை, விநியோகம் மற்றும் சட்ட விவரங்கள்
பீஜின் நெட்வொர்க் நிரலாக்கத்திற்கான வழிகாட்டி என்பது பதிப்புரிமை © 2019 Brian "Beej
Jorgensen" Hall.
Beej's Guide to Network Programming is Copyright © 2019 Brian "Beej
Jorgensen" Hall.
மூலக்குறியீடு (source code) மற்றும் மொழிபெயர்ப்புகள் கீழுள்ள சில விலக்குகளுடன்
அளிக்கப்படுகிறது.
இந்த படைப்பானது கிரியேட்டிவ் காமன்ஸ்-ன் ஆதாரக் குறிப்புடன் – வர்த்தகமற்ற –
மாற்றமற்ற படைப்புகள் 3.0 உரிமத்தின் கீழ் அளிக்கப்படுகிறது. 
(Attribution- Noncommercial- No Derivative Works 3.0 License)
உரிமத்தை பார்க்க : [`https://creativecommons.org/licenses/by-nc-nd/3.0/`](https://creativecommons.org/licenses/by-nc-nd/3.0/)

(அ)
மடல் அனுப்புங்கள் : Creative Commons, 171 Second Street, Suite 300, San
...
(மாற்றமற்ற படைப்புகள்) No Derivative Works பகுதியில் ஒரு விலக்கு பின்வருமாறு
அளிக்கப்படுகிறது. அதாவது இந்த கையேடு ஆனது எந்த மொழியிலும் துல்லியமாக
மொழிபெயர்க்கபடவும் முழுவதுமாக அச்சிடவும் அனுமதி அளிக்கப்படுகிறது.
மொழிபெயர்ப்பிற்கும் மூலக்கையேட்டின் அதே வரம்புகள் பொருந்தும்.
மொழிபெயர்ப்பில் மொழிபெயர்ப்பாளர் பெயர் மற்றும் தொடர்பு விவரங்கள் குறிப்பிடலாம்.
...
இந்த கையேட்டில் உள்ள சி குறியீடானது (source code) பொது வெளியில்
எந்த வகையிலான உரிம வரம்புகளும் இன்றி அளிக்கப்படுகிறது.
...
கல்வியாளர்கள் இந்த கையேட்டினை பரிந்துரை செய்யலாம் (அ) இந்த கையேட்டின் நகல்களையும் அளிக்கலாம்.

Educators are freely encouraged to recommend or supply copies of this
guide to their students.

எழுத்து மூலம் இரு தரப்பினரும் வேறுபட்ட வகையில் ஒப்புக் கொள்ளாவிட்டால்,
ஆசிரியர் இந்தப் படைப்பை “அப்படியே” (as-is) வழங்குகிறார்; மேலும்,
இந்தப் படைப்பை தொடர்பாக எந்தவிதமான உறுதிமொழிகளையும் அல்லது
உத்தரவாதங்களையும் — வெளிப்படையானவை, மறைமுகமானவை, சட்டப்பூர்வமானவை
அல்லது வேறு எந்த வகையிலும்—அளிப்பதில்லை. இதில் (இதற்கே மட்டுப்படாமல்) உரிமைச் சான்று,
வணிகப் பயன்பாட்டிற்கான தகுதி, குறிப்பிட்ட நோக்கத்திற்கான பொருத்தம், மீறலின்மை,
மறைந்த அல்லது பிற குறைபாடுகள் இல்லாமை, துல்லியம், அல்லது பிழைகள் உள்ளதா அல்லது
இல்லையா என்பதற்கான எந்த உத்தரவாதமும் அடங்கும்;
அவை கண்டறியக்கூடியவையா அல்லது இல்லையா என்பதையும் பொருட்படுத்தாமல்.
...
பொருந்தக்கூடிய சட்டம் அவசியப்படுத்தும் அளவைத் தவிர, எந்த நிலையிலும், இந்தப் படைப்பின்
பயன்பாட்டிலிருந்து தோன்றும் சிறப்பு, தற்செயலான, தொடர்ச்சியான, தண்டனை சார்ந்த, அல்லது
உதாரணத் தன்மையுடைய இழப்பீடுகளுக்காக, எந்தவொரு சட்டக் கோட்பாட்டின் அடிப்படையிலும்,
ஆசிரியர் உங்களுக்கு பொறுப்பாக இருப்பதில்லை; அத்தகைய இழப்பீடுகள் ஏற்படும் சாத்தியம் குறித்து 
ஆசிரியருக்கு முன்கூட்டியே அறிவிக்கப்பட்டிருந்தாலும் கூட.
